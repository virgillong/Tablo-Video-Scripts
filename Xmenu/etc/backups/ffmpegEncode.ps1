...
# ----------------------
	...
	$total = $global:fileQueue.Count
		...
		$videoEncoder  = $videoProfile.Video.FFmpeg
		$audioEncoder  = $videoProfile.Audio.FFmpeg
		...
		"DEBUG: Encoders -> preset=$selectedPresetValue, Video=$videoEncoder, Audio=$audioEncoder, Bitrate=$audioBitrate, Channels=$audioChannels, CRF=$videoQuality" |
