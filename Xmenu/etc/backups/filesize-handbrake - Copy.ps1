...
$labelInputDir.Text = "Recorded Folders:"
$labelInputDir.AutoSize = $true
$labelInputDir.Left = 10
$labelInputDir.Top = $top
Set-LabelStyle -Label $labelInputDir -Mode $currentMode

$textboxInputDir = New-Object Windows.Forms.TextBox
$textboxInputDir.Size = New-Object System.Drawing.Size(420,20)
$textboxInputDir.Location = New-Object System.Drawing.Point(200,$top)
...
$browseInputDirButton.Left = 630
$browseInputDirButton.Top = $top-2
